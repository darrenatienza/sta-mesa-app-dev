...
const [residentViewState, { setOpenResetPasswordDialog,setUserID }] = useResidentViewState();
  const [
    { data: getUserDataByPersonID, loading: getUserDataByPersonIDLoading, error: getUserDataByPersonIDError },
    getUserByPersionID
  ] = useAxios(
    {
      ...
      method: 'GET'
        ...
        const [
            { data: getUserData, loading: getUserDataByLoading, error: getUserDataByError },
            getUser
          ] = useAxios(
            {
              url: `/records/users/${residentViewState.userID}`,
    ...
    return (
        ...
        >
          ...
          <DialogActions>
            <Button onClick={() =>setOpenResetPasswordDialog(false)} color="primary">
              Cancel
            </Button>
